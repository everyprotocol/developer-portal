...
import { CAMERA, CAMERA_DEFAULT, CRYPTOS, CRYPTOS_ETH, CRYPTOS_LEDGER, ENDPOINT_DEFAULT, ENDPOINTS, ICON_DEFAULT, ICONS, KEYRING_FILTER, KEYRING_FILTER_DEFAULT, LANGUAGE_DEFAULT, LEDGER_APP, LEDGER_APP_DEFAULT, LEDGER_CONN, LEDGER_CONN_DEFAULT, LOCKING, LOCKING_DEFAULT, METADATA_UP, METADATA_UP_DEFAULT, NOTIFICATION_DEFAULT, PREFIX_DEFAULT, PREFIXES, STORAGE, STORAGE_DEFAULT, UIMODE_DEFAULT, UIMODES, UITHEME_DEFAULT, UITHEMES } from './defaults/index.js';
...
export class Settings implements SettingsStruct {
  ...
  constructor () {
    ...
    this.#keyringFilter = withDefault(KEYRING_FILTER, settings.keyringFilter, KEYRING_FILTER_DEFAULT);
  ...
  public get keyringFilter (): string {
    return this.#keyringFilter;
  }
  ...
  public get (): SettingsStruct {
    return {
      ...
      keyringFilter: this.#keyringFilter,
      uiMode: this.#uiMode,
  ...
  public set (settings: Partial<SettingsStruct>): void {
    ...
    this.#keyringFilter = settings.keyringFilter || this.#keyringFilter;
